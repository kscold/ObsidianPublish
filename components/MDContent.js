  ...
  return (
    <div className="markdown-rendered">
      <Alert severity="info">
        ...
        🌱 <strong>Follow</strong> or <strong>DM</strong> me on Instagram at{" "}
        <span>
          <a href="https://www.instagram.com/ks_cold">ks_cold</a>
        </span>
      </Alert>
      ...
      <footer>
        <p>
          GitHub-Link: <a href="https://github.com/kscold">kscold</a>, © 2024
        </p>
      </footer>
    </div>
  )
